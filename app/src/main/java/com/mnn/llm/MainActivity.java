...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnGoToNewPage = findViewById(R.id.btn_go_to_new_page);
        btnGoToNewPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // 创建启动NewPageActivity的Intent
                Intent intent = new Intent(MainActivity.this, NewPageActivity2.class);
                // 启动NewPageActivity
